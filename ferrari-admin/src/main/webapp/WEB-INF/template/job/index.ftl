            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="jobName" placeholder="任务名称" minlength="4" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">Cron <font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="cronExpression" placeholder="任务Cron" maxlength="100">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="job_address" placeholder="机器地址IP:PORT" maxlength="200">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="run_method_args" placeholder="执行方法入参，多个用,分隔"
                                                     maxlength="200"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="mailReceives" placeholder="邮件联系人，多个用,分隔" maxlength="200">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">失败报警阀值 <font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="failAlarmNum" placeholder="连续失败次数报警阀值" maxlength="200">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">Cron <font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="cronExpression" placeholder="请输入任务Cron" maxlength="100">
                        </div>
