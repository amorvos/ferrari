...
public class FerrariLogManager {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FerrariLogManager.class);
     ...
     */
    public static void writeLog(String runclassFile, String logId, LoggingEvent event, Layout layout)
